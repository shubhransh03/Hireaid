          ...
          <PageHeader
            config={{
              ...
              buttons: [
                {
                  label: "AI Assistant",
                  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>,
                  variant: "secondary",
        ...
        <div className="flex gap-4 items-start overflow-hidden">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4">
            ...
            <div className="bg-white border border-[#eef3fa] rounded-2xl shadow-sm overflow-hidden">
              <div className="relative bg-[#1a1a2e] flex items-center justify-center text-white" style={{ height: '400px' }}>
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-[#2d2d3a] px-4 py-2 flex items-center justify-center gap-4">
                  <button className="p-2 hover:bg-white/10 rounded-lg text-white/80 text-xs flex flex-col items-center gap-1">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" /><path d="M19 10v2a7 7 0 0 1-14 0v-2" /><line x1="12" y1="19" x2="12" y2="23" /></svg>
                    <span>Audio</span>
                  </button>
                  <button className="p-2 hover:bg-white/10 rounded-lg text-white/80 text-xs flex flex-col items-center gap-1">
