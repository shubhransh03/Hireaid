      ...
      <div className="bg-white rounded-xl shadow-lg max-w-[640px] w-full mx-4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6">
            ...
            <>
                ...
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-xl border transition-all ${
                    selected === "custom"
                      ...
                      : "border-border-input hover:border-primary hover:bg-primary-light"
                  }`}
                >
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm text-center font-medium text-text-primary">
                      Create a Custom Job
                    </p>
                  </div>
                </div>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  disabled={!selected}
                  className={`px-5 py-2.5 rounded-lg font-medium text-sm text-white transition-colors
                    ${selected ? "bg-primary hover:bg-primary-dark" : "bg-neutral-dark cursor-not-allowed"}
                  `}
                >
                  Proceed
                </button>
          ...
          {step === "upload" && (
            <>
              <div className="mb-6">
                <label className="block font-medium text-sm text-text-primary mb-3">
                  Upload Job Description File
                </label>
                
                {/* Upload Area */}
                <div className="border-2 border-dashed border-border-input rounded-lg p-8 text-center mb-4">
                  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto mb-3 text-text-placeholder">
                  ...
                  <label
                    htmlFor="file-upload"
                    className="cursor-pointer inline-block font-medium text-sm text-primary hover:underline mb-2"
                  >
                    Upload Document
                  </label>
                ...
                {uploadedFiles.length > 0 && (
                  <div className="space-y-2">
                    {uploadedFiles.map((fileName, index) => (
                      <div
                        key={index}
                        className="flex items-center justify-between p-3 bg-muted-bg rounded-lg border border-border-light"
                      >
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`px-5 py-2.5 rounded-lg font-medium text-sm text-white transition-colors
                    ${uploadedFiles.length > 0 ? "bg-primary hover:bg-primary-dark" : "bg-neutral-dark cursor-not-allowed"}
                  `}
                >
                  Generate Questions
                </button>
            ...
            <>
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={12}
                  maxLength={500}
                  className="w-full p-4 border border-border-input rounded-lg text-sm text-text-primary resize-none focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className={`px-5 py-2.5 rounded-lg font-medium text-sm text-white transition-colors
                    ${aiPrompt.trim().length > 0 ? "bg-primary hover:bg-primary-dark" : "bg-neutral-dark cursor-not-allowed"}
                  `}
                >
                  Proceed
                </button>
