    ...
    return (
        <div className="fixed top-0 right-0 bottom-0 left-[80px] z-[9999] bg-page-bg flex flex-col overflow-hidden">
            ...
            <div className="flex-1 px-8 pt-6 pb-8 overflow-hidden relative">
                {/* Header */}
                <div className="mb-6">
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-success-light text-sm">
                        <span className="w-2 h-2 rounded-full bg-success"></span>
                        <span className="text-success-text font-medium">Technical Evaluation</span>
                    </div>
                </div>

                {/* Question Tag */}
                <div className="mb-4">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md bg-info-light text-info text-xs font-medium">
                        <span className="text-info">MCQ</span>
                    </span>
                </div>
                    ...
                    {[
                        ...
                        <label
                            ...
                            className={`flex items-start gap-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedOption === index
                                    ...
                                    : "border-border-card bg-white hover:border-border-default"
                                }`}
                ...
                <div className="fixed bottom-24 right-8 w-[280px] space-y-3">
                    ...
                    <div className="bg-gray-900 rounded-lg overflow-hidden aspect-video flex items-center justify-center shadow-lg">
                    ...
                    <div className="bg-white rounded-lg p-3 border border-border-light shadow-sm">
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="flex-1">
                                <div className="text-xs font-semibold text-text-primary mb-0.5">AI Assistant</div>
